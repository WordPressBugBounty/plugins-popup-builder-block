...
class Stories
{
    ...
    public function show_story_widget()
    {
        ...
        $this->title = (isset($this->title) && !empty($this->title) ? $this->title . ' ' : '') . __('Stories', 'popup-builder-block');
        wp_add_dashboard_widget('wpmet-stories', $this->title ?? __('Wpmet Stories', 'popup-builder-block'), array($this, 'show'), null, null, 'normal', 'high');
    ...
    {
        return apply_filters('wpmet/stories/footer_links', array(array('url' => 'https://wpmet.com/support-ticket', 'label' => __('Need Help?', 'popup-builder-block'), 'style' => ''), array('url' => 'https://wpmet.com/blog/', 'label' => __('Blog', 'popup-builder-block'), 'style' => ''), array('url' => 'https://wpmet.com/fb-group', 'label' => __('Facebook Community', 'popup-builder-block'), 'style' => 'color: #27ae60;')));
    }
    /**
